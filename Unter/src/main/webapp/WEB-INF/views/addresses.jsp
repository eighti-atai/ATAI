...
<style>
 ...
 .invPartNo.ng-valid {
    ...
    <script src="<c:url value='/static/js/entity/Address.js' />"></script>
</head>
<body>
	<body ng-app="generalModule" class="ng-cloak">
      <div class="generic-container" data-ng-controller="RecordController as ctrl" ng-init="ctrl.init()">
                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      <input type="hidden" ng-model="ctrl.Record.objid" /> 
						...
						<div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.Record.addressId" id="addressId" class="salesPartId form-control input-sm" placeholder="Enter Address Id " required ng-minlength="1"/>
                                  <div class="has-error" ng-show="myForm.$dirty">
                                      <span ng-show="myForm.addressId.$error.required">This is a required field</span>
                                      <span ng-show="myForm.addressId.$error.minlength">Minimum length required is 3</span>
                                      <span ng-show="myForm.addressId.$invalid">This field is invalid </span>
                                  </div>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.Record.street" id="street" class="description form-control input-sm" placeholder="Enter Street." required/>
                              	  <div class="has-error" ng-show="myForm.$dirty">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.Record.city" id="city" class="description form-control input-sm" placeholder="Enter City." required/>
                              	  <div class="has-error" ng-show="myForm.$dirty">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.Record.country" id="country" class="description form-control input-sm" placeholder="Enter Country." required/>
                              	  <div class="has-error" ng-show="myForm.$dirty">
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-heading"><span class="lead">List of Addresses </span></div>
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.Records | startFrom:ctrl.currentPage*ctrl.pageSize | limitTo:ctrl.pageSize " >
                              ...
                              <td ng-if="!ctrl.change(u.objid)"><span ng-bind="u.street"></span></td>
                              <td ng-if="!ctrl.change(u.objid)"><span ng-bind="u.city"></span></td>
                              <td ng-if="!ctrl.change(u.objid)"><span ng-bind="u.country"></span></td>
                                                                                          
                              <td ng-if="ctrl.change(u.objid)"><input type="text" ng-model="u.addressId"style="width: 100%"/></td>
                              <td ng-if="ctrl.change(u.objid)"><input type="text" ng-model="u.street" style="width: 100%""/></td>
                              <td ng-if="ctrl.change(u.objid)"><input type="text" ng-model="u.city"style="width: 100%""/></td>
                              <td ng-if="ctrl.change(u.objid)"><input type="text" ng-model="u.country"style="width: 100%""/></td>
