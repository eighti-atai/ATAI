...
<style>
 ...
 .invPartNo.ng-valid {
    ...
    <script src="<c:url value='/static/js/entity/InvPartInStock.js' />"></script>
</head>
<body ng-app="generalModule" class="ng-cloak">
      <div class="generic-container" data-ng-controller="RecordController as ctrl" ng-init="ctrl.init()">
          <div class="panel panel-default">
              <div class="panel-heading"><span class="lead">Inventory Parts In Stock</span></div>
              <div class="formcontainer">
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
					 ...
					 <div class="row">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="invLocationId">Inventory Location Id</label>
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.Record.id.invLocationId" id="invLocationId" class="description form-control input-sm" placeholder="Enter Inventory Location Id." required/>
                              	  <div class="has-error" ng-show="myForm.$dirty">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="stockQuantity">Quantity</label>
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.Record.stockQuantity" id="stockQuantity" class="description form-control input-sm" placeholder="Enter Quantity." required/>
                              	  <div class="has-error" ng-show="myForm.$dirty">
                                      <span ng-show="myForm.stockQuantity.$error.required">This is a required field</span>
                                  </div>
                              </div>
                          </div>
                      </div>
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-heading"><span class="lead">List of Inventory Parts In Stock </span></div>
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.Records | startFrom:ctrl.currentPage*ctrl.pageSize | limitTo:ctrl.pageSize " >
                              ...
                              <td ng-if="!ctrl.change(u.objid)"><span ng-bind="u.stockQuantity"></span></td>
                              ...
                              <td ng-if="ctrl.change(u.objid)"><input type="text" ng-model="u.stockQuantity"style="width: 100%""/></td>
