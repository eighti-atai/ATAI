...
<body ng-app="generalModule" class="ng-cloak">
      <div class="generic-container" data-ng-controller="RecordController as ctrl" ng-init="ctrl.init()">
          <div class="panel panel-default">
              <div class="panel-heading"><span class="lead">Sites</span></div>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.Record.phoneNo1" id="phoneNo1" class="invPartNo form-control input-sm" placeholder="Enter phone no" required/>
                                  <div class="has-error" ng-show="myForm.$dirty">
   					  ...
   					  <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="number" ng-model="ctrl.Record.phoneNo2" id="phoneNo2" class="invConversionFactor form-control input-sm" placeholder="Enter phone no" required/>
                              </div>
                          </div>
                      </div>
