...
entityModule.factory('EntityService', ['$http', '$q', function($http, $q){
    ...
    var entityRec = {
        ...
        record :{id:{customerOrderId:'',coLineNo:''},salesQty:'',discount:'',amount:'',salesPartId:'',salesPartPriceNo:'',customerOrder:{customerOrderId:'',orderDate:(new Date()),status:'open',note:'kan',paymentNo:'1',customerId:'1', userId:'',objid:null},objid:null},
